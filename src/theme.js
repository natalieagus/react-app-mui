// setup to get all the colours and types, set light and dark mode
...
export const useMode = () => {
  ...
  // we need the correct stuff BEFORE things are being rendered
  // when mode changes, useMemo will recompute the new Theme values (we recompute what themeSettings should return depending on the mode)
